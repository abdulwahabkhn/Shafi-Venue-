...
function ManagementShell() {
  ...
  return <div className="ops-app">
    ...
    <main className="ops-main"><div className="ops-breadcrumb"><span>Shafi Complex & Marquee</span><ArrowRight aria-hidden="true" /><strong>{activeLabel}</strong>{query && <em>Searching “{query}”</em>}</div>{view === "overview" && <LiveOperations view="overview" />}{view === "bookings" && <LiveOperations view="bookings" />}{view === "calendar" && <LiveOperations view="calendar" />}{view === "inventory" && <InventoryWorkspace />}{view === "expenses" && <ExpensesWorkspace />}{view === "employees" && <EmployeesWorkspace />}{view === "reports" && <ReportsWorkspace />}{view === "accounts" && actor.role==='Director' && <AccountsWorkspace />}{view === "website" && <WebsiteView onToast={setToast} />}</main>
