...
for(const resource of ['inventory-register','expense-sheet','monthly-summary','employees']){
 ...
 const required=resource==='inventory-register'?['items','history']:resource==='expense-sheet'?['rows']:resource==='monthly-summary'?['leaves']:['employees','attendance','payments'];
